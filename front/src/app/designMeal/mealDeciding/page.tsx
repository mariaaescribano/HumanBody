...
export default function DesignMeal_MealDeciding() 
{
  ...
  const caloriesNeeded = useRef<string>("");
  ...
  const gestionaDatosSS = async () =>
  {
    ...
    if(datosGuardados!= undefined)
    {
      ...
      let cals= sessionStorage.getItem("caloriasNecesitadas")
      if(cals)
        caloriesNeeded.current = cals;
      else
        caloriesNeeded.current = "0";
    ...
    >
        ...
        >
          ...
          <Text fontSize="10px" fontWeight="700">
            Remember that today you will extra need {caloriesNeeded.current} kcal 
          </Text>
        </Card>
