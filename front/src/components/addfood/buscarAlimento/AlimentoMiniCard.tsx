...
export default function AlimentoMiniCard(props: {nameAlimento:string, predomina:number, calorias:string}) {
  ...
  {hoverColor !== "" && (
    ...
    >
      ...
      <Box display="flex" justifyContent="space-between" alignItems="center" direction="row" width="100%">
        ...
        {/* SVG alineado al final */}
        <Box ml="auto" display="flex" alignItems="center" cursor="pointer" mr="20px">
